...
<html>
	<head>
        ...
        <?php include 'headers/customer_orders_header.php';?>
	</head>
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">Next Store</a>
			</div>
										...
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													...
													<tr><td>Product Price</td><td><b><?php echo "Baht ".$row["product_price"]; ?></b></td></tr>
