...
if(isset($_POST["category"])){
	...
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
					<a href='#' class='category list-group-item' cid='$cid'>$cat_name</a>
			";
		}
	}
}
		...
		while($row = mysqli_fetch_array($run_query)){
            ...
            <div class='col-lg-4 col-md-6 mb-4'>
              <div class='card h-100'>
                <a href='#'><img class='card-img-top' src='product_images/$pro_image' alt=''></a>
                <div class='card-body'>
                  <h4 class='card-title'>
                    <a href='product.php?id=$pro_id'>$pro_title</a>
                  </h4>
                  <h5>$pro_price.00 Baht</h5>
                  <p class='card-text'>$pro_des</p>
                </div>
                <div style='margin-left:30%; margin-left:30%;'><button pid='$pro_id' type='button' id='product' class='btn btn-secondary' style='background-color:#4B0082;' '>Add To Cart</button></div><br>
	...
	while($row=mysqli_fetch_array($run_query)){
			...
			echo "
              ...
              <div class='card h-100'>
                ...
                <div style='margin-left:30%; margin-left:30%;'><button pid='$pro_id' type='button' id='product' class='btn btn-secondary' style='background-color:#4B0082;' '>addToCart</button></div><br>
                <div class='card-footer'>
                  <small class='text-muted'>&#9733; &#9733; &#9733; &#9733; &#9734;</small>
                </div>
				</div>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="Individual" value="nextstore62@gmail.com">
